        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="kategori" class="col-sm-3 col-form-label">Nama Propinsi</label>
                    <div class="col-sm-9">
...
<script>
    $(document).ready(function() {
        const table = $("#table-kategori").DataTable({
            ...
            order: [],
            ajax: {
                url: `${BASE_URL}/master/propinsi/ajax`
            },
            //optional
            lengthMenu: [
                [10, 25,50,100],
            ...
            columns: [
               ...
               
                {
                    data: function(row) {
                        ...
                        let html = '<button class="btn btn-success btn-sm mr-1 ubah" data-id="' + row.id + '" data-nama="' + row.nama + '"><i class="fas fa-edit"></i></button>'
                        html += ''
                        return html;
                    }
                }
        ...
        $(".content").on("click", "#ubah", function(e) {
            ...
            $.ajax({
                type: "post",
                url: `${BASE_URL}/master/propinsi/ubah`,
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
                ...
                success: function(response) {
                    responValidasi(['ubah'], ['nama'], response);
                    if (response.sukses) {
