...
<div class="container-fluid">
    <button class="btn btn-primary mb-1 tambah"><i class="fas fa-plus"></i> Tambah Korwil Kabupaten</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="kategori" class="col-sm-5 col-form-label">Provinsi</label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row">
                    <label for="kategori" class="col-sm-5 col-form-label">Nama Korwil Kabupaten</label>
                    <div class="col-sm-7">
...
<script>
    $(document).ready(function() {
        const table = $("#table-kategori").DataTable({
            ...
            order: [],
            ajax: {
                url: `${BASE_URL}/master/kabupaten/ajax`
            },
            //optional
            lengthMenu: [
                [10, 25,50,100],
        ...
        $(".content").on("click", "#tambah", function(e) {
            ...
            $.ajax({
                type: "post",
                url: `${BASE_URL}/master/kabupaten/tambah`,
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
        ...
        $(".content").on("click", "#ubah", function(e) {
            ...
            $.ajax({
                type: "post",
                url: `${BASE_URL}/master/kabupaten/ubah`,
                dataType: "json",
                contentType: false,
                processData: false,
                cache: false,
        ...
        $(".content").on("click", ".hapus", function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `${BASE_URL}/master/kabupaten/hapus`,
                        data: {
                            id: $(this).data("id")
                        },
                        success: function(response) {
