          ...
          <div class="col-xs-12">
            <div class="bootstrap-table">             
              <div class="fixed-table-container table-no-bordered" style="padding-bottom: 0px;">
                  <!-- tool bar table-->
                  Import file data rekap payout dalam bentuk excell, format dan kolom harus sesuai dengan template import.
                  <!-- -->
						...
						<div class="form-group">
							<div class="text-center">
								...
								<div class="selesai alert alert-primary" role="alert" style="display: none; ">
									<i class="fa fa-info"></i>Upload dan import data berhasil,silakan buka halaman saldo.
								</div>
							</div>
						</div>
						<div class="form-group">
...
<script>
    $(document).ready(function() {
        $("body").on("submit", "#form-upload-user", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo base_url('import/importTransaksipout') ?>",
                data: data,
                dataType: 'json',
                contentType: false,
                cache: false,
